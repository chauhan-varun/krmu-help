...
function Home() {
  ...
  const [guidanceRef, inView] = useInView({
    triggerOnce: true,
    threshold: 0.2,
  });
      ...
      <main className="space-y-4 sm:space-y-8">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <motion.div
                key={index}
                variants={item}
                className="flex items-start gap-2 transform transition-all duration-300 hover:scale-105 hover:bg-gray-700 p-2 rounded-lg"
              >
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-white">Get Guidance for Web Development for <span className="hover:text-blue-400 transition-colors duration-300">FREE</span></h2>
          </div>
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <p className="text-lg">
                ...
                <span className="font-bold hover:text-blue-400 transition-colors duration-300"> help you learn how to build a website</span>, including:
              </p>
            </div>
            <motion.div
              variants={container}
